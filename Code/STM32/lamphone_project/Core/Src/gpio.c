...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, CS_I2C_SPI_Pin|LCD1_DC_Pin|LCD1_CS_Pin|LCD1_RST_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = CS_I2C_SPI_Pin|LCD1_DC_Pin|LCD1_CS_Pin|LCD1_RST_Pin;
